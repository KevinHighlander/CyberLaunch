"""Rule-based significance scoring for CLIM Build 1."""
...
def score_event(title: str, summary: str = "") -> SignificanceResult:
    """Score an event using transparent geopolitical rules."""
    ...
    # Cyberattack affecting critical infrastructure.
    if (
    ...
    # Military activity involving disputed Kuril territory.
    if (
    ...
    # Taiwan blockade/invasion preparations.
    ...
    # Korean nuclear or missile activity.
    if (
        "north korea" in text
        and any(
            term in text
